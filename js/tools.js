...
const QuizEngine = (() => {
  ...
  function finishQuiz() {
    ...
    document.getElementById('resultWrong').textContent = answeredCount - correct;
    document.getElementById('resultSkipped').textContent = total - answeredCount;
    document.getElementById('resultScore').textContent = score;

    let grade, gradeClass, emoji;
    if (pct >= 85) { grade = '🏆 Xuất sắc!'; gradeClass = 'excellent'; emoji = '⭐'; }
    else if (pct >= 70) { grade = '✅ Khá tốt!'; gradeClass = 'good'; emoji = '👍'; }
    else if (pct >= 50) { grade = '📚 Cần ôn thêm'; gradeClass = 'average'; emoji = '📖'; }
    else { grade = '💪 Hãy cố lên!'; gradeClass = 'poor'; emoji = '🔥'; }
  ...
  return { init, filterChapter, selectOption, nextQuestion, prevQuestion, skipQuestion, jumpTo, startQuiz };
})();
